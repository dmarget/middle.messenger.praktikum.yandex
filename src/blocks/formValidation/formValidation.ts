...
export class FormValidator {
  ...
  validateOnBlur() {
    this.fields.forEach((field) => {
      ...
      input.addEventListener("blur", () => {
        this.validateFields(input as HTMLInputElement);
      });
    });
  }
  ...
  setStatus(
    ...
    const errorText = field.parentElement!.querySelector(
      ".label-wrapper__error-info-text"
    ) as HTMLElement;

    if (status === "success") {
      errorText.innerText = "";
      field
        .parentElement!.querySelector(".label-wrapper")!
        .classList.remove("label-wrapper_error");
      field
    ...
    if (status === "error") {
      ...
      field
        .parentElement!.querySelector(".label-wrapper")!
        .classList.add("label-wrapper_error");
      field
        .parentElement!.querySelector(".input")!
